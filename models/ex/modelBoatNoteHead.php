...
class BoatNoteHead {
    ...
    public $CompleteDate = "";
    public $Cancel = 0;
    private $Query1 = "SELECT HeadId, HeadCode,Boat_Id, Berthed_Id , IsNull(Boat_MV,'N/A') AS Boat_MV,IsNull(Boat_LighterNo,'N/A') AS Boat_LighterNo ,IsNull(HB_Name,'N/A') AS HB_Name , Convert(nvarchar(30),CommenceDate) as CMDate ,Convert(nvarchar(30),CompleteDate) AS CPDate,Cancel
             FROM STS_BoatNote_Head
             LEFT JOIN STS_Boat_MT_Boat ON (STS_BoatNote_Head.Boat_Id = STS_Boat_MT_Boat.IdRun)
             LEFT JOIN STS_Boat_MT_Harbor ON (STS_BoatNote_Head.Berthed_Id = STS_Boat_MT_Harbor.IdRun )  ";
